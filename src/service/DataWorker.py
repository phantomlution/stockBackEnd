...
class DataWorker(object):
    ...
    def get_fx_live(date_str):
        ...
        for item in item_list:
            ...
            model = DataWorker.resolve_fx_live_item(item, date_time_str)
            result.append(model)
        ...
        for top_item in top_item_list:
            ...
            model = DataWorker.resolve_fx_live_item(top_item, date_time_str)
            model['isTop'] = True
            result.append(model)
    ...
    def get_gang_gu_tong_suspend_notice():
        ...
        notice_list = DataWorker.get_sse_official_site_notice(url)
    ...
    def get_suspend_notice():
        result = []
        result.extend(DataWorker.get_gang_gu_tong_suspend_notice())
        result.extend(DataWorker.get_sse_suspend_notice())
    ...
    def get_sync_fragment_deal(secid, _date):
        sync_list = DataWorker.get_sync_item_list()
